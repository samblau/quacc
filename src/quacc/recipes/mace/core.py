"""
Core recipes for the MACE MLIP.
"""
...
def static_job(atoms: Atoms, **calc_kwargs) -> RunSchema:
    ...
    atoms
        Atoms object
    **calc_kwargs
        Dictionary of custom kwargs for the MACE calculator. 
    ...
    atoms.calc = mace_mp(**calc_kwargs)
    final_atoms = run_calc(atoms)

    return summarize_run(
        final_atoms, input_atoms=atoms, additional_fields={"name": "MACE Static"}
    )
...
def relax_job(
    ...
    **calc_kwargs
        Custom kwargs for the MACE calculator.
    ...
    return summarize_opt_run(dyn, additional_fields={"name": "MACE Relax"})
...
def freq_job(
    ...
    **calc_kwargs
    ...
    return summarize_vib_and_thermo(
        ...
        pressure=pressure,
        additional_fields={"name": "MACE Frequency and Thermo"},
    )
